...
const checks = [
  ...
  check("vibe-coding product mission", [
    ...
    "working.md"
  ], ["vibe-coding education app", "GitHub URL, local source folder", "AI-native build briefing", "not a traditional programming course", "not a language syntax tutor", "project's mission", "architecture, folder and file responsibilities", "important terms", "prompt strategy", "verification boundaries", "PRD", "TDD", "acceptance criteria", "recreate or extend similar software with better judgment", "not embed external repositories as permanent knowledge", "static source evidence", "verify AI output"]),
  ...
  check("vibe-coding prompt pack", [
    ...
    "packages/html/src/templates.ts",
    "apps/cli/src/index.ts"
  ], ["VibeCodingPromptPackReportSchema", "VibeCodingPromptPackReport", "vibeCodingPromptPackReport", "vibe-coding-prompt-pack-report.json", "vibe-coding-prompt-pack.md", "vibe-coding-prompt-pack.html", "AI-native vibe-coding prompt pack", "나는 전문 개발자가 아니라 바이브코딩 개발자야", "promptSequence", "copyPastePrompt", "aiGuardrails", "contextBundle", "learnerChecklist", "PRD", "TDD", "acceptance criteria", "Vibe-Coding Prompt Pack", "AI Implementation Prompt Pack", "Copy/Paste Prompt", "vibe-prompt-pack-card", "vibe-prompt-sequence", "vibe-prompt-guardrails", "openTargetEntries", "vibe-coding-prompt-pack"]),
