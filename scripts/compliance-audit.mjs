...
const checks = [
  ...
  check("Server framework readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["ServerFrameworkReadinessReportSchema", "ServerFrameworkReadinessReport", "serverFrameworkReadinessReport", "server-framework-readiness-report.json", "server-framework-readiness.md", "server-framework-readiness.html", "Fastify Hono fastify route get post schema register plugin addHook decorate setErrorHandler listen inject logger withTypeProvider FastifyInstance FastifyPluginCallback FastifyPluginAsync addContentTypeParser childLoggerFactory new Hono app.route basePath app.use c.req c.json validator zValidator hc testClient app.fetch serve", "serverSetups", "routeSignals", "schemaSignals", "pluginSignals", "lifecycleSignals", "runtimeSignals", "errorSignals", "testSignals", "fastifySignals", "honoSignals", "packageSignals", "Fastify Signals", "Fastify", "Hono", "server-framework-readiness-card", "data-source-pattern=\"Fastify Hono\"", "openTargetEntries", "server-framework-readiness"]),
