...
const checks = [
  ...
  check("Dialog readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["DialogReadinessReportSchema", "DialogReadinessReport", "dialogReadinessReport", "dialog-readiness-report.json", "dialog-readiness.md", "dialog-readiness.html", "Dialog readiness Radix Dialog Headless UI Dialog Ariakit Dialog portal overlay focus trap dismiss accessibility tests", "dialogSetups", "frameworkSignals", "structureSignals", "stateSignals", "focusSignals", "dismissalSignals", "portalOverlaySignals", "accessibilitySignals", "animationSignals", "testSignals", "packageSignals", "RepoTutor records dialog readiness only", "dialog-readiness-card", "data-source-pattern=\"Dialog\"", "openTargetEntries", "dialog-readiness"]),
  check("Popover tooltip readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["PopoverTooltipReadinessReportSchema", "PopoverTooltipReadinessReport", "popoverTooltipReadinessReport", "popover-tooltip-readiness-report.json", "popover-tooltip-readiness.md", "popover-tooltip-readiness.html", "Popover/tooltip readiness Radix Popover Radix Tooltip Floating UI Ariakit Popover Tooltip portal positioning hover focus dismissal accessibility tests", "popoverTooltipSetups", "frameworkSignals", "structureSignals", "positioningSignals", "interactionSignals", "dismissalSignals", "focusSignals", "accessibilitySignals", "portalSignals", "testSignals", "packageSignals", "RepoTutor records popover/tooltip readiness only", "popover-tooltip-readiness-card", "data-source-pattern=\"PopoverTooltip\"", "openTargetEntries", "popover-tooltip-readiness"]),
  check("Menu dropdown readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["MenuDropdownReadinessReportSchema", "MenuDropdownReadinessReport", "menuDropdownReadinessReport", "menu-dropdown-readiness-report.json", "menu-dropdown-readiness.md", "menu-dropdown-readiness.html", "Menu/dropdown readiness Radix DropdownMenu ContextMenu Menubar NavigationMenu Headless UI Menu Listbox Combobox Ariakit Menu Select Combobox keyboard selection accessibility tests", "menuDropdownSetups", "frameworkSignals", "structureSignals", "selectionSignals", "positioningSignals", "interactionSignals", "accessibilitySignals", "stateSignals", "testSignals", "packageSignals", "RepoTutor records menu/dropdown readiness only", "menu-dropdown-readiness-card", "data-source-pattern=\"MenuDropdown\"", "openTargetEntries", "menu-dropdown-readiness"]),
  check("Toast snackbar readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["ToastSnackbarReadinessReportSchema", "ToastSnackbarReadinessReport", "toastSnackbarReadinessReport", "toast-snackbar-readiness-report.json", "toast-snackbar-readiness.md", "toast-snackbar-readiness.html", "Toast/snackbar readiness Radix Toast Sonner React Hot Toast Notistack provider viewport lifecycle action close accessibility timer swipe tests", "toastSnackbarSetups", "frameworkSignals", "structureSignals", "variantSignals", "lifecycleSignals", "interactionSignals", "accessibilitySignals", "stylingSignals", "testSignals", "packageSignals", "RepoTutor records toast/snackbar readiness only", "toast-snackbar-readiness-card", "data-source-pattern=\"ToastSnackbar\"", "openTargetEntries", "toast-snackbar-readiness"]),
  check("Tabs accordion readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["TabsAccordionReadinessReportSchema", "TabsAccordionReadinessReport", "tabsAccordionReadinessReport", "tabs-accordion-readiness-report.json", "tabs-accordion-readiness.md", "tabs-accordion-readiness.html", "Tabs/accordion readiness Radix Tabs Accordion Collapsible Headless UI Tab Disclosure Ariakit Tab Disclosure keyboard orientation controlled state accessibility tests", "tabsAccordionSetups", "frameworkSignals", "structureSignals", "stateSignals", "interactionSignals", "accessibilitySignals", "orientationSignals", "testSignals", "packageSignals", "RepoTutor records tabs/accordion/disclosure readiness only", "tabs-accordion-readiness-card", "data-source-pattern=\"TabsAccordion\"", "openTargetEntries", "tabs-accordion-readiness"]),
  check("Checkbox radio switch readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["CheckboxRadioSwitchReadinessReportSchema", "CheckboxRadioSwitchReadinessReport", "checkboxRadioSwitchReadinessReport", "checkbox-radio-switch-readiness-report.json", "checkbox-radio-switch-readiness.md", "checkbox-radio-switch-readiness.html", "Checkbox/radio/switch readiness Radix Checkbox RadioGroup Switch Headless UI Checkbox RadioGroup Switch Ariakit Checkbox Radio checked defaultChecked indeterminate aria-checked form tests", "checkboxRadioSwitchSetups", "frameworkSignals", "controlSignals", "structureSignals", "stateSignals", "formSignals", "interactionSignals", "accessibilitySignals", "testSignals", "packageSignals", "RepoTutor records checkbox/radio/switch readiness only", "checkbox-radio-switch-readiness-card", "data-source-pattern=\"CheckboxRadioSwitch\"", "openTargetEntries", "checkbox-radio-switch-readiness"]),
  check("Slider progress readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["SliderProgressReadinessReportSchema", "SliderProgressReadinessReport", "sliderProgressReadinessReport", "slider-progress-readiness-report.json", "slider-progress-readiness.md", "slider-progress-readiness.html", "Slider/progress readiness Radix Slider Progress native input range progressbar value min max step orientation aria-valuenow form tests", "sliderProgressSetups", "frameworkSignals", "structureSignals", "valueSignals", "interactionSignals", "orientationSignals", "formSignals", "accessibilitySignals", "testSignals", "packageSignals", "RepoTutor records slider/progress readiness only", "slider-progress-readiness-card", "data-source-pattern=\"SliderProgress\"", "openTargetEntries", "slider-progress-readiness"]),
  check("Select combobox readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["SelectComboboxReadinessReportSchema", "SelectComboboxReadinessReport", "selectComboboxReadinessReport", "select-combobox-readiness-report.json", "select-combobox-readiness.md", "select-combobox-readiness.html", "Select/combobox/listbox readiness Radix Select Headless UI Combobox Listbox Ariakit Select Combobox value option aria-activedescendant form tests", "selectComboboxSetups", "frameworkSignals", "structureSignals", "stateSignals", "interactionSignals", "accessibilitySignals", "formSignals", "testSignals", "packageSignals", "RepoTutor records select/combobox/listbox readiness only", "select-combobox-readiness-card", "data-source-pattern=\"SelectCombobox\"", "openTargetEntries", "select-combobox-readiness"]),
  ...
  check("Tags input readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["TagsInputReadinessReportSchema", "TagsInputReadinessReport", "tagsInputReadinessReport", "tags-input-readiness-report.json", "tags-input-readiness.md", "tags-input-readiness.html", "Tags input readiness Zag tags input value array editable tags paste delimiter validation live region form hidden input keyboard delete accessibility tests", "tagsInputSetups", "frameworkSignals", "structureSignals", "valueSignals", "validationSignals", "interactionSignals", "accessibilitySignals", "formSignals", "liveRegionSignals", "testSignals", "packageSignals", "RepoTutor records tags input readiness only", "tags-input-readiness-card", "data-source-pattern=\"TagsInput\"", "openTargetEntries", "tags-input-readiness"]),
  ...
  check("Floating panel readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["FloatingPanelReadinessReportSchema", "FloatingPanelReadinessReport", "floatingPanelReadinessReport", "floating-panel-readiness-report.json", "floating-panel-readiness.md", "floating-panel-readiness.html", "Floating panel readiness Zag floating-panel drag resize stage stack boundary focus accessibility tests", "floatingPanelSetups", "frameworkSignals", "structureSignals", "stateSignals", "layoutSignals", "dragResizeSignals", "stackSignals", "focusAccessibilitySignals", "testSignals", "packageSignals", "RepoTutor records floating panel readiness only", "floating-panel-readiness-card", "data-source-pattern=\"FloatingPanel\"", "openTargetEntries", "floating-panel-readiness"]),
