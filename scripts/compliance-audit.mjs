...
const checks = [
  ...
  check("Select combobox readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["SelectComboboxReadinessReportSchema", "SelectComboboxReadinessReport", "selectComboboxReadinessReport", "select-combobox-readiness-report.json", "select-combobox-readiness.md", "select-combobox-readiness.html", "Select/combobox/listbox readiness Radix Select Headless UI Combobox Listbox Ariakit Select Combobox Listbox machine stack top layer typeahead form fields floating portal option registration value option aria-activedescendant form tests", "selectComboboxSetups", "frameworkSignals", "structureSignals", "stateSignals", "interactionSignals", "accessibilitySignals", "formSignals", "implementationSignals", "Implementation Signals", "controllable-value", "default-value-hook", "comparator", "listbox-machine", "data-ref-sync", "slice-state", "stack-machine", "top-layer", "outside-click-close", "refocus-button", "label-provider", "form-fields", "open-closed-provider", "floating-provider", "quick-release", "active-press", "floating-reference", "handle-toggle", "keyboard-open", "attempt-submit", "aria-haspopup-listbox", "button-aria-expanded", "button-aria-controls", "options-anchor", "portal-enabled", "transition-data", "disappear-close", "scroll-lock", "inert-others", "frozen-value", "active-descendant", "multiselectable", "orientation", "open-tab-index", "typeahead-search", "search-timeout", "select-active-option", "focus-next-prev", "focus-first-last", "tab-close-focus-next", "register-option", "unregister-option", "scroll-into-view", "pointer-tracking", "option-role", "aria-selected", "data-focus", "testSignals", "packageSignals", "RepoTutor records select/combobox/listbox readiness only", "select-combobox-readiness-card", "data-source-pattern=\"SelectCombobox\"", "openTargetEntries", "select-combobox-readiness"]),
  ...
  check("Presence readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["PresenceReadinessReportSchema", "PresenceReadinessReport", "presenceReadinessReport", "presence-readiness-report.json", "presence-readiness.md", "presence-readiness.html", "Presence readiness Zag presence mounted unmountSuspended unmounted animation exitcomplete visibility immediate tests", "presenceSetups", "frameworkSignals", "stateSignals", "lifecycleSignals", "animationSignals", "visibilitySignals", "machineSignals", "contextSignals", "effectSignals", "actionSignals", "apiSignals", "node-null-guard", "node-set-event", "unmount-event", "state-matches-present", "initial-skip", "props-create-props", "present-prop", "on-exit-complete-prop", "immediate-prop", "presence-api-interface", "skip-boolean", "present-boolean", "set-node-nullable", "unmount-void-api", "presence-service-type", "presence-machine-type", "present-coerce-boolean", "initial-state-present-prop", "exitcomplete-bubbles-false", "node-dispatch-event", "same-node-guard", "computed-style-cache", "visibility-hidden-unmount", "raf-presence-check", "animation-name-none", "display-none-unmount", "zero-duration-unmount", "unmount-suspend-event", "testSignals", "packageSignals", "@zag-js/presence", "@zag-js/react", "@zag-js/core", "@zag-js/dom-query", "@zag-js/types", "Machine Signals", "RepoTutor records presence readiness only", "presence-readiness-card", "data-source-pattern=\"Presence\"", "openTargetEntries", "presence-readiness"]),
