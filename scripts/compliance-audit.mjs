...
const checks = [
  ...
  ], ["repo-tutor study", "repo-tutor quiz", "--enable-codex", "Do not execute arbitrary project commands", "pnpm --dir \"$repo_root\" --filter @repotutor/cli dev -- study", "repo-tutor command not found and RepoTutor Studio root could not be located", "permanent app knowledge"]),
  ...
  ], ["study_source", "enableCodex", "enable_codex", "Codex SDK", "--enable-codex", "REPOTUTOR_SIDECAR", "Node sidecar", "CORE_LEARNING_REPORT_TARGETS", "target-grid", "report-preview", "repo-tutor open <session> --target", "overview", "language", "daily-summary", "vibe-coding-prompt-pack", "learning-path", "glossary", "rebuild", "verify:learning-targets", "verify-learning-targets.mjs", "openTargetEntries", "cli-open-target-missing", "desktop-learning-target-surface-missing"]),
