...
const checks = [
  ...
  check("lesson generation outputs", [
    ...
    "packages/shared/src/schemas.ts"
  ], ["PurposeReport", "FolderLesson", "FileLesson", "FlowReport", "RebuildRoadmap", "sourceEvidence", "source-evidence", "소스 근거", "evidenceBackedFiles", "evidenceCoverageRatio", "filesWithoutEvidence"]),
  check("quiz engine", [
