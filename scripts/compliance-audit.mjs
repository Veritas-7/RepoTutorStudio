...
const checks = [
  ...
  ], ["repo-tutor study", "repo-tutor quiz", "--no-codex", "Do not execute arbitrary project commands", "pnpm --dir \"$repo_root\" --filter @repotutor/cli dev -- study", "repo-tutor command not found and RepoTutor Studio root could not be located", "permanent app knowledge"]),
