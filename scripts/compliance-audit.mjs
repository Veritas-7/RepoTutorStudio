...
const checks = [
  ...
  check("Tabs accordion readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["TabsAccordionReadinessReportSchema", "TabsAccordionReadinessReport", "tabsAccordionReadinessReport", "tabs-accordion-readiness-report.json", "tabs-accordion-readiness.md", "tabs-accordion-readiness.html", "Tabs/accordion readiness Radix Tabs Accordion Collapsible Headless UI Tab Disclosure Ariakit Tab Disclosure Zag Accordion machine DOM API keyboard orientation controlled state accessibility tests", "tabsAccordionSetups", "frameworkSignals", "structureSignals", "stateSignals", "interactionSignals", "accessibilitySignals", "orientationSignals", "machineSignals", "domSignals", "apiSignals", "@zag-js/accordion", "Machine Signals", "DOM Signals", "API Signals", "testSignals", "packageSignals", "RepoTutor records tabs/accordion/disclosure readiness only", "tabs-accordion-readiness-card", "data-source-pattern=\"TabsAccordion\"", "openTargetEntries", "tabs-accordion-readiness"]),
  ...
  check("Presence readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["PresenceReadinessReportSchema", "PresenceReadinessReport", "presenceReadinessReport", "presence-readiness-report.json", "presence-readiness.md", "presence-readiness.html", "Presence readiness Zag presence mounted unmountSuspended unmounted animation exitcomplete visibility immediate tests", "presenceSetups", "frameworkSignals", "stateSignals", "lifecycleSignals", "animationSignals", "visibilitySignals", "machineSignals", "contextSignals", "effectSignals", "actionSignals", "apiSignals", "node-null-guard", "node-set-event", "unmount-event", "state-matches-present", "initial-skip", "testSignals", "packageSignals", "@zag-js/presence", "@zag-js/react", "@zag-js/core", "@zag-js/dom-query", "@zag-js/types", "Machine Signals", "RepoTutor records presence readiness only", "presence-readiness-card", "data-source-pattern=\"Presence\"", "openTargetEntries", "presence-readiness"]),
