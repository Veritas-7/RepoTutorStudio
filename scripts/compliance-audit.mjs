...
const checks = [
  ...
  check("Vector DB readiness report", [
    ...
    "packages/core/src/session-verifier.ts",
    "packages/core/src/pipeline.test.ts"
  ], ["VectorDbReadinessReportSchema", "VectorDbReadinessReport", "vectorDbReadinessReport", "vector-db-readiness-report.json", "vector-db-readiness.md", "vector-db-readiness.html", "Vector DB readiness Qdrant Weaviate Chroma LangChain VectorStore VectorStoreRetriever MMR similaritySearchWithScore addVectors addDocuments asRetriever collections classes schema vector config embeddings vectorizer distance dimensions HNSW payload metadata filters hybrid search BM25 sparse vectors upsert add query search nearest neighbors score limit snapshots backup restore sharding replication tenancy ttl clients endpoints API keys persistence", "vectorSetups", "collectionSignals", "clientSignals", "ingestionSignals", "querySignals", "similarity-with-score", "mmr", "as-retriever", "embeddingSignals", "embed-documents", "embed-query", "indexSignals", "opsSignals", "saveable-vectorstore", "packageSignals", "@langchain/core", "langchain", "Vector DB", "vector-db-readiness-card", "data-source-pattern=\"Vector DB\"", "openTargetEntries", "vector-db-readiness"]),
