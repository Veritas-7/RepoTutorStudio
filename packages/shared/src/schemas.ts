...
export const CollapsibleReadinessReportSchema = z.object({
  ...
  apiSignals: z.array(z.object({
    signal: z.enum(["disabled", "visible", "open", "measure-size", "set-open", "root-props", "content-props", "trigger-props", "indicator-props", "collapsed-size", "hidden-content", "css-vars", "aria-expanded", "aria-controls", "unknown"]),
    readiness: z.enum(["ready", "missing", "external"]),
    evidence: z.string(),
    relatedHref: z.string()
  })),
...
export const HoverCardReadinessReportSchema = z.object({
  ...
  packageSignals: z.array(z.object({
    signal: z.enum(["@zag-js/hover-card", "@zag-js/dismissable", "@zag-js/popper", "@zag-js/dom-query", "@zag-js/anatomy", "react", "unknown"]),
    readiness: z.enum(["ready", "missing", "external"]),
    evidence: z.string(),
    relatedHref: z.string()
  })),
...
export const TooltipReadinessReportSchema = z.object({
  ...
  apiSignals: z.array(z.object({
    signal: z.enum(["open", "set-open", "trigger-value-api", "set-trigger-value", "reposition-api", "trigger-props", "arrow-props", "arrow-tip-props", "positioner-props", "content-props", "aria-describedby", "role-tooltip", "data-state", "data-placement", "data-side", "pointer-events", "unknown"]),
    readiness: z.enum(["ready", "missing", "external"]),
    evidence: z.string(),
    relatedHref: z.string()
  })),
