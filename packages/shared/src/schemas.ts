...
export const LlmReadinessReportSchema = z.object({
  ...
  runnableSignals: z.array(z.object({
    signal: z.enum(["runnable-sequence", "runnable-lambda", "runnable-passthrough", "runnable-map", "pipe-chain", "invoke", "batch", "stream", "as-tool", "with-message-history", "message-history-store", "message-history-config", "message-history-keys", "message-history-insert", "message-history-persist", "message-filter", "message-run-merge", "message-trim", "message-chunk-conversion", "response-metadata-merge", "usage-metadata-merge", "runnable-config", "config-ensure", "config-merge", "config-patch", "config-pick-keys", "runnable-callback-manager-config", "async-local-config", "recursion-limit", "config-timeout-signal", "configurable-runtime", "runnable-branch", "branch-condition", "branch-default", "runnable-binding", "config-factory", "runnable-each", "runnable-retry", "retry-attempt-handler", "runnable-with-fallbacks", "runnable-assign", "runnable-pick", "map-key-callback", "runnable-stream-log", "runnable-stream-events", "runnable-coercion", "with-retry", "with-fallbacks", "unknown"]),
    readiness: z.enum(["ready", "missing", "external"]),
    evidence: z.string(),
    relatedHref: z.string()
  })),
  toolSignals: z.array(z.object({
    signal: z.enum(["tool", "tool-schema", "tool-calling", "agent", "agent-executor", "agent-middleware", "middleware-state-schema", "middleware-context-schema", "wrap-model-call", "wrap-tool-call", "before-model", "after-model", "before-agent", "after-agent", "dynamic-tool", "hitl-interrupt", "hitl-review-config", "headless-tool", "headless-tool-overload", "headless-tool-implementation", "headless-tool-interrupt", "headless-tool-metadata", "summarization-middleware", "context-editing", "context-clear-tool-uses", "llm-tool-selector", "ai-message-tool-calls", "tool-call-parser", "tool-call-chunk", "tool-message-artifact", "tool-message-status", "server-tool-call-block", "mcp-tool", "mcp-client", "mcp-load-tools", "mcp-list-tools-pagination", "mcp-json-schema-deref", "mcp-schema-simplify", "mcp-tool-hooks", "mcp-before-tool-call", "mcp-after-tool-call", "mcp-artifact-content", "mcp-structured-content", "mcp-meta-artifact", "mcp-command-result", "mcp-tool-message", "mcp-client-fork", "mcp-progress-callback", "mcp-tool-exception", "mcp-output-handling", "unknown"]),
    readiness: z.enum(["ready", "missing", "external"]),
    evidence: z.string(),
    relatedHref: z.string()
  })),
