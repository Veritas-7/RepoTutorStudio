...
import type { TerminalUiReadinessReport } from "@repotutor/shared";
import type { StateMachineReadinessReport } from "@repotutor/shared";
import type { AnimationReadinessReport } from "@repotutor/shared";
import type { DragAndDropReadinessReport } from "@repotutor/shared";
import type { RichTextEditorReadinessReport } from "@repotutor/shared";
import type { CommandPaletteReadinessReport } from "@repotutor/shared";
...
import type { ScrollAreaReadinessReport } from "@repotutor/shared";
...
import type { TagsInputReadinessReport } from "@repotutor/shared";
...
export function markdownFiles(session: StudySession, analysis: AnalysisBundle, quiz: Quiz, wrongNotes: WrongNote[]): Record<string, string> {
  const files: Record<string, string> = {
    ...
    "markdown-code-rendering-readiness.md": `# Markdown Code Rendering Readiness\n\n${analysis.markdownCodeRenderingReadinessReport.summary}\n\nSource pattern: ${analysis.markdownCodeRenderingReadinessReport.sourcePattern}\n\n## Markdown Code Rendering Setups\n\n${markdownCodeRenderingReadinessSetupMarkdown(analysis.markdownCodeRenderingReadinessReport.markdownCodeRenderingSetups)}\n\n## Renderer Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.rendererSignals, "signal")}\n\n## Parser Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.parserSignals, "signal")}\n\n## Highlight Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.highlightSignals, "signal")}\n\n## Plugin Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.pluginSignals, "signal")}\n\n## Security Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.securitySignals, "signal")}\n\n## Theme Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.themeSignals, "signal")}\n\n## Accessibility Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${markdownCodeRenderingReadinessSignalMarkdown(analysis.markdownCodeRenderingReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.markdownCodeRenderingReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.markdownCodeRenderingReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.markdownCodeRenderingReadinessReport.learnerNextSteps)}\n`,
    ...
    "terminal-ui-readiness.md": `# Terminal UI Readiness\n\n${analysis.terminalUiReadinessReport.summary}\n\nSource pattern: ${analysis.terminalUiReadinessReport.sourcePattern}\n\n## Terminal UI Setups\n\n${terminalUiReadinessSetupMarkdown(analysis.terminalUiReadinessReport.terminalSetups)}\n\n## Framework Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.frameworkSignals, "signal")}\n\n## Screen Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.screenSignals, "signal")}\n\n## Layout Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.layoutSignals, "signal")}\n\n## Input Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.inputSignals, "signal")}\n\n## Focus Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.focusSignals, "signal")}\n\n## Mouse Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.mouseSignals, "signal")}\n\n## Render Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.renderSignals, "signal")}\n\n## Lifecycle Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.lifecycleSignals, "signal")}\n\n## Test Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${terminalUiReadinessSignalMarkdown(analysis.terminalUiReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.terminalUiReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.terminalUiReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.terminalUiReadinessReport.learnerNextSteps)}\n`,
    "state-machine-readiness.md": `# State Machine Readiness\n\n${analysis.stateMachineReadinessReport.summary}\n\nSource pattern: ${analysis.stateMachineReadinessReport.sourcePattern}\n\n## State Machine Setups\n\n${stateMachineReadinessSetupMarkdown(analysis.stateMachineReadinessReport.stateMachineSetups)}\n\n## Framework Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.frameworkSignals, "signal")}\n\n## State Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.stateSignals, "signal")}\n\n## Transition Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.transitionSignals, "signal")}\n\n## Action Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.actionSignals, "signal")}\n\n## Guard Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.guardSignals, "signal")}\n\n## Actor Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.actorSignals, "signal")}\n\n## Context Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.contextSignals, "signal")}\n\n## Event Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.eventSignals, "signal")}\n\n## Test Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${stateMachineReadinessSignalMarkdown(analysis.stateMachineReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.stateMachineReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.stateMachineReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.stateMachineReadinessReport.learnerNextSteps)}\n`,
    "animation-readiness.md": `# Animation Readiness\n\n${analysis.animationReadinessReport.summary}\n\nSource pattern: ${analysis.animationReadinessReport.sourcePattern}\n\n## Animation Setups\n\n${animationReadinessSetupMarkdown(analysis.animationReadinessReport.animationSetups)}\n\n## Library Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.librarySignals, "signal")}\n\n## Declaration Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.declarationSignals, "signal")}\n\n## Timing Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.timingSignals, "signal")}\n\n## Interaction Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.interactionSignals, "signal")}\n\n## Layout Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.layoutSignals, "signal")}\n\n## Accessibility Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.accessibilitySignals, "signal")}\n\n## Runtime Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.runtimeSignals, "signal")}\n\n## Test Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${animationReadinessSignalMarkdown(analysis.animationReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.animationReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.animationReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.animationReadinessReport.learnerNextSteps)}\n`,
    "drag-and-drop-readiness.md": `# Drag And Drop Readiness\n\n${analysis.dragAndDropReadinessReport.summary}\n\nSource pattern: ${analysis.dragAndDropReadinessReport.sourcePattern}\n\n## Drag And Drop Setups\n\n${dragAndDropReadinessSetupMarkdown(analysis.dragAndDropReadinessReport.dragAndDropSetups)}\n\n## Library Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.librarySignals, "signal")}\n\n## Provider Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.providerSignals, "signal")}\n\n## Sensor Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.sensorSignals, "signal")}\n\n## Draggable Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.draggableSignals, "signal")}\n\n## Droppable Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.droppableSignals, "signal")}\n\n## Sortable Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.sortableSignals, "signal")}\n\n## Feedback Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.feedbackSignals, "signal")}\n\n## Accessibility Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${dragAndDropReadinessSignalMarkdown(analysis.dragAndDropReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.dragAndDropReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.dragAndDropReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.dragAndDropReadinessReport.learnerNextSteps)}\n`,
    "rich-text-editor-readiness.md": `# Rich Text Editor Readiness\n\n${analysis.richTextEditorReadinessReport.summary}\n\nSource pattern: ${analysis.richTextEditorReadinessReport.sourcePattern}\n\n## Rich Text Editor Setups\n\n${richTextEditorReadinessSetupMarkdown(analysis.richTextEditorReadinessReport.richTextEditorSetups)}\n\n## Framework Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.frameworkSignals, "signal")}\n\n## Schema Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.schemaSignals, "signal")}\n\n## Render Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.renderSignals, "signal")}\n\n## Command Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.commandSignals, "signal")}\n\n## State Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.stateSignals, "signal")}\n\n## Extension Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.extensionSignals, "signal")}\n\n## Collaboration Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.collaborationSignals, "signal")}\n\n## Accessibility Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${richTextEditorReadinessSignalMarkdown(analysis.richTextEditorReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.richTextEditorReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.richTextEditorReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.richTextEditorReadinessReport.learnerNextSteps)}\n`,
    "command-palette-readiness.md": `# Command Palette Readiness\n\n${analysis.commandPaletteReadinessReport.summary}\n\nSource pattern: ${analysis.commandPaletteReadinessReport.sourcePattern}\n\n## Command Palette Setups\n\n${commandPaletteReadinessSetupMarkdown(analysis.commandPaletteReadinessReport.commandPaletteSetups)}\n\n## Framework Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.frameworkSignals, "signal")}\n\n## Input Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.inputSignals, "signal")}\n\n## Result Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.resultSignals, "signal")}\n\n## Selection Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.selectionSignals, "signal")}\n\n## Filter Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.filterSignals, "signal")}\n\n## State Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.stateSignals, "signal")}\n\n## Plugin Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.pluginSignals, "signal")}\n\n## Accessibility Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.accessibilitySignals, "signal")}\n\n## Keyboard Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.keyboardSignals, "signal")}\n\n## Test Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${commandPaletteReadinessSignalMarkdown(analysis.commandPaletteReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.commandPaletteReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.commandPaletteReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.commandPaletteReadinessReport.learnerNextSteps)}\n`,
    "guided-tour-readiness.md": `# Guided Tour Readiness\n\n${analysis.guidedTourReadinessReport.summary}\n\nSource pattern: ${analysis.guidedTourReadinessReport.sourcePattern}\n\n## Guided Tour Setups\n\n${guidedTourReadinessSetupMarkdown(analysis.guidedTourReadinessReport.guidedTourSetups)}\n\n## Framework Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.frameworkSignals, "signal")}\n\n## Step Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.stepSignals, "signal")}\n\n## Target Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.targetSignals, "signal")}\n\n## Navigation Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.navigationSignals, "signal")}\n\n## Overlay Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.overlaySignals, "signal")}\n\n## Callback Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.callbackSignals, "signal")}\n\n## Accessibility Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.accessibilitySignals, "signal")}\n\n## State Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.stateSignals, "signal")}\n\n## Test Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${guidedTourReadinessSignalMarkdown(analysis.guidedTourReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.guidedTourReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.guidedTourReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.guidedTourReadinessReport.learnerNextSteps)}\n`,
    "data-table-readiness.md": `# Data Table Readiness\n\n${analysis.dataTableReadinessReport.summary}\n\nSource pattern: ${analysis.dataTableReadinessReport.sourcePattern}\n\n## Data Table Setups\n\n${dataTableReadinessSetupMarkdown(analysis.dataTableReadinessReport.dataTableSetups)}\n\n## Framework Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.frameworkSignals, "signal")}\n\n## Column Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.columnSignals, "signal")}\n\n## Row Model Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.rowModelSignals, "signal")}\n\n## Interaction Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.interactionSignals, "signal")}\n\n## State Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.stateSignals, "signal")}\n\n## Virtualization Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.virtualizationSignals, "signal")}\n\n## Editing Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.editingSignals, "signal")}\n\n## Accessibility Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${dataTableReadinessSignalMarkdown(analysis.dataTableReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.dataTableReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.dataTableReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.dataTableReadinessReport.learnerNextSteps)}\n`,
...
`,
  ...
  files["calendar-readiness.md"] = `# Calendar Readiness\n\n${analysis.calendarReadinessReport.summary}\n\nSource pattern: ${analysis.calendarReadinessReport.sourcePattern}\n\n## Calendar Setups\n\n${calendarReadinessSetupMarkdown(analysis.calendarReadinessReport.calendarSetups)}\n\n## Framework Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.frameworkSignals, "signal")}\n\n## View Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.viewSignals, "signal")}\n\n## Event Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.eventSignals, "signal")}\n\n## Selection Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.selectionSignals, "signal")}\n\n## Navigation Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.navigationSignals, "signal")}\n\n## Localization Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.localizationSignals, "signal")}\n\n## Resource Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.resourceSignals, "signal")}\n\n## Drag Drop Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.dragDropSignals, "signal")}\n\n## Range Constraint Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.rangeConstraintSignals, "signal")}\n\n## Accessibility Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${calendarReadinessSignalMarkdown(analysis.calendarReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.calendarReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.calendarReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.calendarReadinessReport.learnerNextSteps)}\n`;
  files["dialog-readiness.md"] = `# Dialog Readiness\n\n${analysis.dialogReadinessReport.summary}\n\nSource pattern: ${analysis.dialogReadinessReport.sourcePattern}\n\n## Dialog Setups\n\n${dialogReadinessSetupMarkdown(analysis.dialogReadinessReport.dialogSetups)}\n\n## Framework Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.stateSignals, "signal")}\n\n## Focus Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.focusSignals, "signal")}\n\n## Dismissal Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.dismissalSignals, "signal")}\n\n## Portal Overlay Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.portalOverlaySignals, "signal")}\n\n## Accessibility Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.accessibilitySignals, "signal")}\n\n## Animation Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.animationSignals, "signal")}\n\n## Test Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${dialogReadinessSignalMarkdown(analysis.dialogReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.dialogReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.dialogReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.dialogReadinessReport.learnerNextSteps)}\n`;
  files["popover-tooltip-readiness.md"] = `# Popover Tooltip Readiness\n\n${analysis.popoverTooltipReadinessReport.summary}\n\nSource pattern: ${analysis.popoverTooltipReadinessReport.sourcePattern}\n\n## Popover Tooltip Setups\n\n${popoverTooltipReadinessSetupMarkdown(analysis.popoverTooltipReadinessReport.popoverTooltipSetups)}\n\n## Framework Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.structureSignals, "signal")}\n\n## Positioning Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.positioningSignals, "signal")}\n\n## Interaction Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.interactionSignals, "signal")}\n\n## Dismissal Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.dismissalSignals, "signal")}\n\n## Focus Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.focusSignals, "signal")}\n\n## Accessibility Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.accessibilitySignals, "signal")}\n\n## Portal Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.portalSignals, "signal")}\n\n## Test Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${popoverTooltipReadinessSignalMarkdown(analysis.popoverTooltipReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.popoverTooltipReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.popoverTooltipReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.popoverTooltipReadinessReport.learnerNextSteps)}\n`;
  files["menu-dropdown-readiness.md"] = `# Menu Dropdown Readiness\n\n${analysis.menuDropdownReadinessReport.summary}\n\nSource pattern: ${analysis.menuDropdownReadinessReport.sourcePattern}\n\n## Menu Dropdown Setups\n\n${menuDropdownReadinessSetupMarkdown(analysis.menuDropdownReadinessReport.menuDropdownSetups)}\n\n## Framework Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.structureSignals, "signal")}\n\n## Selection Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.selectionSignals, "signal")}\n\n## Positioning Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.positioningSignals, "signal")}\n\n## Interaction Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.accessibilitySignals, "signal")}\n\n## State Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.stateSignals, "signal")}\n\n## Test Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${menuDropdownReadinessSignalMarkdown(analysis.menuDropdownReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.menuDropdownReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.menuDropdownReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.menuDropdownReadinessReport.learnerNextSteps)}\n`;
  files["toast-snackbar-readiness.md"] = `# Toast Snackbar Readiness\n\n${analysis.toastSnackbarReadinessReport.summary}\n\nSource pattern: ${analysis.toastSnackbarReadinessReport.sourcePattern}\n\n## Toast Snackbar Setups\n\n${toastSnackbarReadinessSetupMarkdown(analysis.toastSnackbarReadinessReport.toastSnackbarSetups)}\n\n## Framework Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.structureSignals, "signal")}\n\n## Variant Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.variantSignals, "signal")}\n\n## Lifecycle Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.lifecycleSignals, "signal")}\n\n## Interaction Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.accessibilitySignals, "signal")}\n\n## Styling Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.stylingSignals, "signal")}\n\n## Test Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${toastSnackbarReadinessSignalMarkdown(analysis.toastSnackbarReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.toastSnackbarReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.toastSnackbarReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.toastSnackbarReadinessReport.learnerNextSteps)}\n`;
  files["tabs-accordion-readiness.md"] = `# Tabs Accordion Readiness\n\n${analysis.tabsAccordionReadinessReport.summary}\n\nSource pattern: ${analysis.tabsAccordionReadinessReport.sourcePattern}\n\n## Tabs Accordion Setups\n\n${tabsAccordionReadinessSetupMarkdown(analysis.tabsAccordionReadinessReport.tabsAccordionSetups)}\n\n## Framework Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.stateSignals, "signal")}\n\n## Interaction Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.accessibilitySignals, "signal")}\n\n## Orientation Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.orientationSignals, "signal")}\n\n## Test Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${tabsAccordionReadinessSignalMarkdown(analysis.tabsAccordionReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.tabsAccordionReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.tabsAccordionReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.tabsAccordionReadinessReport.learnerNextSteps)}\n`;
  files["checkbox-radio-switch-readiness.md"] = `# Checkbox Radio Switch Readiness\n\n${analysis.checkboxRadioSwitchReadinessReport.summary}\n\nSource pattern: ${analysis.checkboxRadioSwitchReadinessReport.sourcePattern}\n\nRepoTutor records checkbox/radio/switch readiness only; it does not toggle controls, change checked state, move focus, dispatch keyboard/click events, submit forms, mutate stores, or run analyzed project tests.\n\n## Checkbox Radio Switch Setups\n\n${checkboxRadioSwitchReadinessSetupMarkdown(analysis.checkboxRadioSwitchReadinessReport.checkboxRadioSwitchSetups)}\n\n## Framework Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.frameworkSignals, "signal")}\n\n## Control Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.controlSignals, "signal")}\n\n## Structure Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.stateSignals, "signal")}\n\n## Form Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.formSignals, "signal")}\n\n## Interaction Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${checkboxRadioSwitchReadinessSignalMarkdown(analysis.checkboxRadioSwitchReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.checkboxRadioSwitchReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.checkboxRadioSwitchReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.checkboxRadioSwitchReadinessReport.learnerNextSteps)}\n`;
  files["slider-progress-readiness.md"] = `# Slider Progress Readiness\n\n${analysis.sliderProgressReadinessReport.summary}\n\nSource pattern: ${analysis.sliderProgressReadinessReport.sourcePattern}\n\nRepoTutor records slider/progress readiness only; it does not drag thumbs, change values, dispatch pointer/keyboard events, submit forms, mutate stores, animate indicators, or run analyzed project tests.\n\n## Slider Progress Setups\n\n${sliderProgressReadinessSetupMarkdown(analysis.sliderProgressReadinessReport.sliderProgressSetups)}\n\n## Framework Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.valueSignals, "signal")}\n\n## Interaction Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.interactionSignals, "signal")}\n\n## Orientation Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.orientationSignals, "signal")}\n\n## Form Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.formSignals, "signal")}\n\n## Accessibility Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${sliderProgressReadinessSignalMarkdown(analysis.sliderProgressReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.sliderProgressReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.sliderProgressReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.sliderProgressReadinessReport.learnerNextSteps)}\n`;
  files["select-combobox-readiness.md"] = `# Select Combobox Readiness\n\n${analysis.selectComboboxReadinessReport.summary}\n\nSource pattern: ${analysis.selectComboboxReadinessReport.sourcePattern}\n\nRepoTutor records select/combobox/listbox readiness only; it does not open popups, type queries, move active options, select values, submit forms, mutate stores, or run analyzed project tests.\n\n## Select Combobox Setups\n\n${selectComboboxReadinessSetupMarkdown(analysis.selectComboboxReadinessReport.selectComboboxSetups)}\n\n## Framework Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.stateSignals, "signal")}\n\n## Interaction Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.accessibilitySignals, "signal")}\n\n## Form Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.formSignals, "signal")}\n\n## Test Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${selectComboboxReadinessSignalMarkdown(analysis.selectComboboxReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.selectComboboxReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.selectComboboxReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.selectComboboxReadinessReport.learnerNextSteps)}\n`;
  files["toolbar-toggle-readiness.md"] = `# Toolbar Toggle Readiness\n\n${analysis.toolbarToggleReadinessReport.summary}\n\nSource pattern: ${analysis.toolbarToggleReadinessReport.sourcePattern}\n\nRepoTutor records toolbar/toggle readiness only; it does not click buttons, toggle pressed state, move focus, dispatch keyboard events, mutate stores, submit forms, or run analyzed project tests.\n\n## Toolbar Toggle Setups\n\n${toolbarToggleReadinessSetupMarkdown(analysis.toolbarToggleReadinessReport.toolbarToggleSetups)}\n\n## Framework Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.stateSignals, "signal")}\n\n## Focus Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.focusSignals, "signal")}\n\n## Orientation Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.orientationSignals, "signal")}\n\n## Accessibility Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${toolbarToggleReadinessSignalMarkdown(analysis.toolbarToggleReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.toolbarToggleReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.toolbarToggleReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.toolbarToggleReadinessReport.learnerNextSteps)}\n`;
  files["scroll-area-readiness.md"] = `# Scroll Area Readiness\n\n${analysis.scrollAreaReadinessReport.summary}\n\nSource pattern: ${analysis.scrollAreaReadinessReport.sourcePattern}\n\nRepoTutor records scroll area readiness only; it does not scroll viewports, drag thumbs, dispatch wheel or pointer events, mutate scroll positions, measure live layout, or run analyzed project tests.\n\n## Scroll Area Setups\n\n${scrollAreaReadinessSetupMarkdown(analysis.scrollAreaReadinessReport.scrollAreaSetups)}\n\n## Framework Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.stateSignals, "signal")}\n\n## Measurement Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.measurementSignals, "signal")}\n\n## Orientation Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.orientationSignals, "signal")}\n\n## Interaction Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${scrollAreaReadinessSignalMarkdown(analysis.scrollAreaReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.scrollAreaReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.scrollAreaReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.scrollAreaReadinessReport.learnerNextSteps)}\n`;
  files["avatar-readiness.md"] = `# Avatar Readiness\n\n${analysis.avatarReadinessReport.summary}\n\nSource pattern: ${analysis.avatarReadinessReport.sourcePattern}\n\nRepoTutor records avatar readiness only; it does not load images, dispatch load/error events, mutate src, hydrate DOM, measure natural size, or run analyzed project tests.\n\n## Avatar Setups\n\n${avatarReadinessSetupMarkdown(analysis.avatarReadinessReport.avatarSetups)}\n\n## Framework Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.stateSignals, "signal")}\n\n## Image Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.imageSignals, "signal")}\n\n## Event Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.eventSignals, "signal")}\n\n## SSR Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.ssrSignals, "signal")}\n\n## Accessibility Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${avatarReadinessSignalMarkdown(analysis.avatarReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.avatarReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.avatarReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.avatarReadinessReport.learnerNextSteps)}\n`;
  files["pin-input-readiness.md"] = `# Pin Input Readiness\n\n${analysis.pinInputReadinessReport.summary}\n\nSource pattern: ${analysis.pinInputReadinessReport.sourcePattern}\n\nRepoTutor records pin input readiness only; it does not type codes, paste clipboard data, dispatch keyboard/input events, submit forms, mutate values, move focus, or run analyzed project tests.\n\n## Pin Input Setups\n\n${pinInputReadinessSetupMarkdown(analysis.pinInputReadinessReport.pinInputSetups)}\n\n## Framework Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.valueSignals, "signal")}\n\n## Validation Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.validationSignals, "signal")}\n\n## Interaction Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.interactionSignals, "signal")}\n\n## Form Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.formSignals, "signal")}\n\n## Accessibility Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${pinInputReadinessSignalMarkdown(analysis.pinInputReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.pinInputReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.pinInputReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.pinInputReadinessReport.learnerNextSteps)}\n`;
  files["pagination-readiness.md"] = `# Pagination Readiness\n\n${analysis.paginationReadinessReport.summary}\n\nSource pattern: ${analysis.paginationReadinessReport.sourcePattern}\n\nRepoTutor records pagination readiness only; it does not click page controls, change page state, fetch server pages, slice live data, follow pagination links, mutate table state, or run analyzed project tests.\n\n## Pagination Setups\n\n${paginationReadinessSetupMarkdown(analysis.paginationReadinessReport.paginationSetups)}\n\n## Framework Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.structureSignals, "signal")}\n\n## State Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.stateSignals, "signal")}\n\n## Navigation Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.navigationSignals, "signal")}\n\n## Render Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.renderSignals, "signal")}\n\n## Accessibility Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${paginationReadinessSignalMarkdown(analysis.paginationReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.paginationReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.paginationReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.paginationReadinessReport.learnerNextSteps)}\n`;
  files["number-input-readiness.md"] = `# Number Input Readiness\n\n${analysis.numberInputReadinessReport.summary}\n\nSource pattern: ${analysis.numberInputReadinessReport.sourcePattern}\n\nRepoTutor records number input readiness only; it does not press spin buttons, type values, dispatch wheel or pointer events, mutate inputs, clamp live values, request pointer lock, submit forms, or run analyzed project tests.\n\n## Number Input Setups\n\n${numberInputReadinessSetupMarkdown(analysis.numberInputReadinessReport.numberInputSetups)}\n\n## Framework Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.valueSignals, "signal")}\n\n## Bounds Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.boundsSignals, "signal")}\n\n## Format Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.formatSignals, "signal")}\n\n## Keyboard Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.keyboardSignals, "signal")}\n\n## Interaction Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.accessibilitySignals, "signal")}\n\n## Form Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.formSignals, "signal")}\n\n## Test Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${numberInputReadinessSignalMarkdown(analysis.numberInputReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.numberInputReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.numberInputReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.numberInputReadinessReport.learnerNextSteps)}\n`;
  files["rating-group-readiness.md"] = `# Rating Group Readiness\n\n${analysis.ratingGroupReadinessReport.summary}\n\nSource pattern: ${analysis.ratingGroupReadinessReport.sourcePattern}\n\nRepoTutor records rating group readiness only; it does not click ratings, hover stars, dispatch keyboard or pointer events, mutate values, submit forms, reset forms, or run analyzed project tests.\n\n## Rating Group Setups\n\n${ratingGroupReadinessSetupMarkdown(analysis.ratingGroupReadinessReport.ratingGroupSetups)}\n\n## Framework Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.valueSignals, "signal")}\n\n## Selection Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.selectionSignals, "signal")}\n\n## Interaction Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.accessibilitySignals, "signal")}\n\n## Form Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.formSignals, "signal")}\n\n## Test Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${ratingGroupReadinessSignalMarkdown(analysis.ratingGroupReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.ratingGroupReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.ratingGroupReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.ratingGroupReadinessReport.learnerNextSteps)}\n`;
  files["color-picker-readiness.md"] = `# Color Picker Readiness\n\n${analysis.colorPickerReadinessReport.summary}\n\nSource pattern: ${analysis.colorPickerReadinessReport.sourcePattern}\n\nRepoTutor records color picker readiness only; it does not sample screen colors, drag thumbs, dispatch keyboard or pointer events, mutate color channels, invoke EyeDropper, submit forms, or run analyzed project tests.\n\n## Color Picker Setups\n\n${colorPickerReadinessSetupMarkdown(analysis.colorPickerReadinessReport.colorPickerSetups)}\n\n## Framework Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.valueSignals, "signal")}\n\n## Channel Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.channelSignals, "signal")}\n\n## Interaction Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.accessibilitySignals, "signal")}\n\n## Form Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.formSignals, "signal")}\n\n## Test Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${colorPickerReadinessSignalMarkdown(analysis.colorPickerReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.colorPickerReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.colorPickerReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.colorPickerReadinessReport.learnerNextSteps)}\n`;
  files["splitter-readiness.md"] = `# Splitter Readiness\n\n${analysis.splitterReadinessReport.summary}\n\nSource pattern: ${analysis.splitterReadinessReport.sourcePattern}\n\nRepoTutor records splitter readiness only; it does not resize panels, drag separators, dispatch keyboard or pointer events, mutate panel sizes, collapse panels, observe layout, or run analyzed project tests.\n\n## Splitter Setups\n\n${splitterReadinessSetupMarkdown(analysis.splitterReadinessReport.splitterSetups)}\n\n## Framework Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.structureSignals, "signal")}\n\n## Size Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.sizeSignals, "signal")}\n\n## Collapse Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.collapseSignals, "signal")}\n\n## Interaction Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.accessibilitySignals, "signal")}\n\n## Registry Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.registrySignals, "signal")}\n\n## Test Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${splitterReadinessSignalMarkdown(analysis.splitterReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.splitterReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.splitterReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.splitterReadinessReport.learnerNextSteps)}\n`;
  files["tags-input-readiness.md"] = `# Tags Input Readiness\n\n${analysis.tagsInputReadinessReport.summary}\n\nSource pattern: ${analysis.tagsInputReadinessReport.sourcePattern}\n\nRepoTutor records tags input readiness only; it does not type tags, paste clipboard data, edit tags, click delete controls, dispatch keyboard or pointer events, mutate tag arrays, submit forms, reset forms, announce live regions, or run analyzed project tests.\n\n## Tags Input Setups\n\n${tagsInputReadinessSetupMarkdown(analysis.tagsInputReadinessReport.tagsInputSetups)}\n\n## Framework Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.valueSignals, "signal")}\n\n## Validation Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.validationSignals, "signal")}\n\n## Interaction Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.interactionSignals, "signal")}\n\n## Accessibility Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.accessibilitySignals, "signal")}\n\n## Form Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.formSignals, "signal")}\n\n## Live Region Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.liveRegionSignals, "signal")}\n\n## Test Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${tagsInputReadinessSignalMarkdown(analysis.tagsInputReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.tagsInputReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.tagsInputReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.tagsInputReadinessReport.learnerNextSteps)}\n`;
  files["clipboard-readiness.md"] = `# Clipboard Readiness\n\n${analysis.clipboardReadinessReport.summary}\n\nSource pattern: ${analysis.clipboardReadinessReport.sourcePattern}\n\nRepoTutor records clipboard readiness only; it does not write to the system clipboard, call navigator.clipboard, execute copy commands, select DOM ranges, mutate copied status, advance timers, or run analyzed project tests.\n\n## Clipboard Setups\n\n${clipboardReadinessSetupMarkdown(analysis.clipboardReadinessReport.clipboardSetups)}\n\n## Framework Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.valueSignals, "signal")}\n\n## Copy Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.copySignals, "signal")}\n\n## Status Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.statusSignals, "signal")}\n\n## Accessibility Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${clipboardReadinessSignalMarkdown(analysis.clipboardReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.clipboardReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.clipboardReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.clipboardReadinessReport.learnerNextSteps)}\n`;
  files["qr-code-readiness.md"] = `# QR Code Readiness\n\n${analysis.qrCodeReadinessReport.summary}\n\nSource pattern: ${analysis.qrCodeReadinessReport.sourcePattern}\n\nRepoTutor records QR code readiness only; it does not encode live QR matrices, render SVG pixels, convert data URLs, click download anchors, generate files, scan QR codes, or run analyzed project tests.\n\n## QR Code Setups\n\n${qrCodeReadinessSetupMarkdown(analysis.qrCodeReadinessReport.qrCodeSetups)}\n\n## Framework Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.frameworkSignals, "signal")}\n\n## Structure Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.structureSignals, "signal")}\n\n## Value Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.valueSignals, "signal")}\n\n## Encoding Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.encodingSignals, "signal")}\n\n## Download Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.downloadSignals, "signal")}\n\n## Accessibility Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.accessibilitySignals, "signal")}\n\n## Test Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.testSignals, "signal")}\n\n## Package Signals\n\n${qrCodeReadinessSignalMarkdown(analysis.qrCodeReadinessReport.packageSignals, "signal")}\n\n## Recommended Commands\n\n${analysis.qrCodeReadinessReport.recommendedCommands.map((item) => `- \`${item.command}\`: ${item.purpose}`).join("\n")}\n\n## Risk Queue\n\n${analysis.qrCodeReadinessReport.riskQueue.map((item) => `- ${item.priority}: ${item.action}\n  - Why: ${item.why}\n  - Related: [${item.relatedHref}](../${item.relatedHref})`).join("\n") || "- 없음"}\n\n## 다음 확인 단계\n\n${bulletsOrNone(analysis.qrCodeReadinessReport.learnerNextSteps)}\n`;
  return files;
}
...
function markdownCodeRenderingReadinessSetupMarkdown(items: MarkdownCodeRenderingReadinessReport["markdownCodeRenderingSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Renderer/parser/highlight/plugin/security/theme/accessibility/tests: ${item.rendererCount}/${item.parserCount}/${item.highlightCount}/${item.pluginCount}/${item.securityCount}/${item.themeCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function markdownCodeRenderingReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}
...
function terminalUiReadinessSetupMarkdown(items: TerminalUiReadinessReport["terminalSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Component/screen/render/layout/input/focus/mouse/raw/alt/resize/style/widget/test: ${item.componentCount}/${item.screenCount}/${item.renderCount}/${item.layoutCount}/${item.inputCount}/${item.focusCount}/${item.mouseCount}/${item.rawModeCount}/${item.altScreenCount}/${item.resizeCount}/${item.styleCount}/${item.widgetCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function terminalUiReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function stateMachineReadinessSetupMarkdown(items: StateMachineReadinessReport["stateMachineSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Machine/state/transition/action/guard/actor/invoke/context/event/test: ${item.machineCount}/${item.stateCount}/${item.transitionCount}/${item.actionCount}/${item.guardCount}/${item.actorCount}/${item.invokeCount}/${item.contextCount}/${item.eventCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function stateMachineReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function animationReadinessSetupMarkdown(items: AnimationReadinessReport["animationSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Component/timeline/keyframe/spring/gesture/layout/accessibility/test: ${item.componentCount}/${item.timelineCount}/${item.keyframeCount}/${item.springCount}/${item.gestureCount}/${item.layoutCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function animationReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function dragAndDropReadinessSetupMarkdown(items: DragAndDropReadinessReport["dragAndDropSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Provider/draggable/droppable/sortable/sensor/feedback/accessibility/test: ${item.providerCount}/${item.draggableCount}/${item.droppableCount}/${item.sortableCount}/${item.sensorCount}/${item.feedbackCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function dragAndDropReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function richTextEditorReadinessSetupMarkdown(items: RichTextEditorReadinessReport["richTextEditorSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Schema/render/command/state/extension/collaboration/accessibility/test: ${item.schemaCount}/${item.renderCount}/${item.commandCount}/${item.stateCount}/${item.extensionCount}/${item.collaborationCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function richTextEditorReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function commandPaletteReadinessSetupMarkdown(items: CommandPaletteReadinessReport["commandPaletteSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Input/result/selection/filter/state/plugin/accessibility/keyboard/test: ${item.inputCount}/${item.resultCount}/${item.selectionCount}/${item.filterCount}/${item.stateCount}/${item.pluginCount}/${item.accessibilityCount}/${item.keyboardCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function commandPaletteReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function guidedTourReadinessSetupMarkdown(items: GuidedTourReadinessReport["guidedTourSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Step/target/navigation/overlay/callback/accessibility/state/test: ${item.stepCount}/${item.targetCount}/${item.navigationCount}/${item.overlayCount}/${item.callbackCount}/${item.accessibilityCount}/${item.stateCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function guidedTourReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function dataTableReadinessSetupMarkdown(items: DataTableReadinessReport["dataTableSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - Column/row/sort/filter/pagination/virtualization/selection/editing/accessibility/test: ${item.columnCount}/${item.rowCount}/${item.sortCount}/${item.filterCount}/${item.paginationCount}/${item.virtualizationCount}/${item.selectionCount}/${item.editingCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function dataTableReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function calendarReadinessSetupMarkdown(items: CalendarReadinessReport["calendarSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.platform}/${item.readiness}]\n  - View/event/selection/navigation/localization/resource/drag-drop/range/accessibility/test: ${item.viewCount}/${item.eventCount}/${item.selectionCount}/${item.navigationCount}/${item.localizationCount}/${item.resourceCount}/${item.dragDropCount}/${item.rangeCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function calendarReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function dialogReadinessSetupMarkdown(items: DialogReadinessReport["dialogSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Trigger/portal/overlay/content/title-description/state/focus/dismiss/accessibility/test: ${item.triggerCount}/${item.portalCount}/${item.overlayCount}/${item.contentCount}/${item.titleDescriptionCount}/${item.stateCount}/${item.focusCount}/${item.dismissCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function dialogReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function popoverTooltipReadinessSetupMarkdown(items: PopoverTooltipReadinessReport["popoverTooltipSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Trigger/anchor/portal/content/position/interaction/dismiss/focus/accessibility/test: ${item.triggerCount}/${item.anchorCount}/${item.portalCount}/${item.contentCount}/${item.positionCount}/${item.interactionCount}/${item.dismissCount}/${item.focusCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function popoverTooltipReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function menuDropdownReadinessSetupMarkdown(items: MenuDropdownReadinessReport["menuDropdownSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Trigger/content/item/selection/positioning/interaction/accessibility/test: ${item.triggerCount}/${item.contentCount}/${item.itemCount}/${item.selectionCount}/${item.positioningCount}/${item.interactionCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function menuDropdownReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function toastSnackbarReadinessSetupMarkdown(items: ToastSnackbarReadinessReport["toastSnackbarSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Provider/viewport/toast/title-description/action/close/variant/lifecycle/accessibility/test: ${item.providerCount}/${item.viewportCount}/${item.toastCount}/${item.titleDescriptionCount}/${item.actionCount}/${item.closeCount}/${item.variantCount}/${item.lifecycleCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function toastSnackbarReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function tabsAccordionReadinessSetupMarkdown(items: TabsAccordionReadinessReport["tabsAccordionSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/list/trigger/content/item/panel/state/keyboard/accessibility/test: ${item.rootCount}/${item.listCount}/${item.triggerCount}/${item.contentCount}/${item.itemCount}/${item.panelCount}/${item.stateCount}/${item.keyboardCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function tabsAccordionReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function checkboxRadioSwitchReadinessSetupMarkdown(items: CheckboxRadioSwitchReadinessReport["checkboxRadioSwitchSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Checkbox/radio/switch/provider/item/indicator/state/form/accessibility/test: ${item.checkboxCount}/${item.radioCount}/${item.switchCount}/${item.providerCount}/${item.itemCount}/${item.indicatorCount}/${item.stateCount}/${item.formCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function checkboxRadioSwitchReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function sliderProgressReadinessSetupMarkdown(items: SliderProgressReadinessReport["sliderProgressSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Slider/progress/track/range/thumb/indicator/value/keyboard/orientation/form/accessibility/test: ${item.sliderCount}/${item.progressCount}/${item.trackCount}/${item.rangeCount}/${item.thumbCount}/${item.indicatorCount}/${item.valueCount}/${item.keyboardCount}/${item.orientationCount}/${item.formCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function sliderProgressReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function selectComboboxReadinessSetupMarkdown(items: SelectComboboxReadinessReport["selectComboboxSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Select/combobox/listbox/trigger/input/options/option/value/popover/form/accessibility/test: ${item.selectCount}/${item.comboboxCount}/${item.listboxCount}/${item.triggerCount}/${item.inputCount}/${item.optionsCount}/${item.optionCount}/${item.valueCount}/${item.portalPopoverCount}/${item.formCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function selectComboboxReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function toolbarToggleReadinessSetupMarkdown(items: ToolbarToggleReadinessReport["toolbarToggleSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Toolbar/toggle/toggle-group/item/separator/button-link/pressed/focus/orientation/keyboard/accessibility/test: ${item.toolbarCount}/${item.toggleCount}/${item.toggleGroupCount}/${item.itemCount}/${item.separatorCount}/${item.buttonLinkCount}/${item.pressedStateCount}/${item.rovingFocusCount}/${item.orientationCount}/${item.keyboardCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function toolbarToggleReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function scrollAreaReadinessSetupMarkdown(items: ScrollAreaReadinessReport["scrollAreaSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Scroll area/viewport/content/scrollbar/thumb/corner/orientation/overflow/measurement/interaction/accessibility/test: ${item.scrollAreaCount}/${item.viewportCount}/${item.contentCount}/${item.scrollbarCount}/${item.thumbCount}/${item.cornerCount}/${item.orientationCount}/${item.overflowCount}/${item.measurementCount}/${item.interactionCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function scrollAreaReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function avatarReadinessSetupMarkdown(items: AvatarReadinessReport["avatarSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Avatar/image/fallback/loading-status/delay/src/alt/event/ssr/accessibility/test: ${item.avatarCount}/${item.imageCount}/${item.fallbackCount}/${item.loadingStatusCount}/${item.delayCount}/${item.srcCount}/${item.altCount}/${item.eventCount}/${item.ssrCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function avatarReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function pinInputReadinessSetupMarkdown(items: PinInputReadinessReport["pinInputSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/input/hidden-input/value/validation/interaction/form/accessibility/test: ${item.rootCount}/${item.inputCount}/${item.hiddenInputCount}/${item.valueCount}/${item.validationCount}/${item.interactionCount}/${item.formCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function pinInputReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function paginationReadinessSetupMarkdown(items: PaginationReadinessReport["paginationSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/item/trigger/ellipsis/page-state/page-size/range/navigation/link/accessibility/test: ${item.rootCount}/${item.itemCount}/${item.triggerCount}/${item.ellipsisCount}/${item.pageStateCount}/${item.pageSizeCount}/${item.rangeCount}/${item.navigationCount}/${item.linkCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function paginationReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function numberInputReadinessSetupMarkdown(items: NumberInputReadinessReport["numberInputSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/input/trigger/scrubber/value/bounds/format/keyboard/interaction/accessibility/form/test: ${item.rootCount}/${item.inputCount}/${item.triggerCount}/${item.scrubberCount}/${item.valueCount}/${item.boundsCount}/${item.formatCount}/${item.keyboardCount}/${item.interactionCount}/${item.accessibilityCount}/${item.formCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function numberInputReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function ratingGroupReadinessSetupMarkdown(items: RatingGroupReadinessReport["ratingGroupSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/label/hidden-input/control/item/value/hover/half/keyboard/pointer/accessibility/form/test: ${item.rootCount}/${item.labelCount}/${item.hiddenInputCount}/${item.controlCount}/${item.itemCount}/${item.valueCount}/${item.hoverCount}/${item.halfCount}/${item.keyboardCount}/${item.pointerCount}/${item.accessibilityCount}/${item.formCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function ratingGroupReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function colorPickerReadinessSetupMarkdown(items: ColorPickerReadinessReport["colorPickerSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/label/control/trigger/content/area/area-thumb/channel-slider/channel-input/swatch/eyedropper/format/value/interaction/accessibility/form/test: ${item.rootCount}/${item.labelCount}/${item.controlCount}/${item.triggerCount}/${item.contentCount}/${item.areaCount}/${item.areaThumbCount}/${item.channelSliderCount}/${item.channelInputCount}/${item.swatchCount}/${item.eyeDropperCount}/${item.formatCount}/${item.valueCount}/${item.interactionCount}/${item.accessibilityCount}/${item.formCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function colorPickerReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function splitterReadinessSetupMarkdown(items: SplitterReadinessReport["splitterSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/panel/handle/size/collapse/keyboard/pointer/orientation/bounds/accessibility/registry/test: ${item.rootCount}/${item.panelCount}/${item.handleCount}/${item.sizeCount}/${item.collapseCount}/${item.keyboardCount}/${item.pointerCount}/${item.orientationCount}/${item.boundsCount}/${item.accessibilityCount}/${item.registryCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function splitterReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function tagsInputReadinessSetupMarkdown(items: TagsInputReadinessReport["tagsInputSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/input/hidden/item/edit/delete/value/validation/interaction/accessibility/form/live-region/test: ${item.rootCount}/${item.inputCount}/${item.hiddenInputCount}/${item.itemCount}/${item.editCount}/${item.deleteCount}/${item.valueCount}/${item.validationCount}/${item.interactionCount}/${item.accessibilityCount}/${item.formCount}/${item.liveRegionCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function tagsInputReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function clipboardReadinessSetupMarkdown(items: ClipboardReadinessReport["clipboardSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/input/trigger/indicator/value/copy/status/timer/accessibility/fallback/test: ${item.rootCount}/${item.inputCount}/${item.triggerCount}/${item.indicatorCount}/${item.valueCount}/${item.copyCount}/${item.statusCount}/${item.timerCount}/${item.accessibilityCount}/${item.fallbackCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function clipboardReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}

function qrCodeReadinessSetupMarkdown(items: QrCodeReadinessReport["qrCodeSetups"]): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item.filePath} [${item.framework}/${item.readiness}]\n  - Root/frame/pattern/overlay/download/value/encoding/pixel/render/data-url/accessibility/test: ${item.rootCount}/${item.frameCount}/${item.patternCount}/${item.overlayCount}/${item.downloadCount}/${item.valueCount}/${item.encodingCount}/${item.pixelCount}/${item.renderCount}/${item.dataUrlCount}/${item.accessibilityCount}/${item.testCount}\n  - Evidence: ${item.evidence}\n  - Source: [${item.sourceHref}](../${item.sourceHref})`).join("\n");
}

function qrCodeReadinessSignalMarkdown<T extends string>(items: Array<Record<T, string> & { readiness: string; evidence: string; relatedHref: string }>, labelKey: T): string {
  if (items.length === 0) return "- 없음";
  return items.map((item) => `- ${item[labelKey]} [${item.readiness}]: ${item.evidence} ([related](../${item.relatedHref}))`).join("\n");
}
