...
export async function loadStudyHtmlInput(sessionRoot: string): Promise<Parameters<typeof renderStudyHtml>[0]> {
  ...
  return {
    ...
    dailySummaryReport: await readJson(path.join(sessionRoot, "analysis", "daily-summary-report.json")),
    ...
    sliderProgressReadinessReport: await readJson(path.join(sessionRoot, "analysis", "slider-progress-readiness-report.json")),
    selectComboboxReadinessReport: await readJson(path.join(sessionRoot, "analysis", "select-combobox-readiness-report.json")),
    toolbarToggleReadinessReport: await readJson(path.join(sessionRoot, "analysis", "toolbar-toggle-readiness-report.json")),
    scrollAreaReadinessReport: await readJson(path.join(sessionRoot, "analysis", "scroll-area-readiness-report.json")),
    avatarReadinessReport: await readJson(path.join(sessionRoot, "analysis", "avatar-readiness-report.json")),
    pinInputReadinessReport: await readJson(path.join(sessionRoot, "analysis", "pin-input-readiness-report.json")),
    paginationReadinessReport: await readJson(path.join(sessionRoot, "analysis", "pagination-readiness-report.json")),
    numberInputReadinessReport: await readJson(path.join(sessionRoot, "analysis", "number-input-readiness-report.json")),
    ratingGroupReadinessReport: await readJson(path.join(sessionRoot, "analysis", "rating-group-readiness-report.json")),
    colorPickerReadinessReport: await readJson(path.join(sessionRoot, "analysis", "color-picker-readiness-report.json")),
    splitterReadinessReport: await readJson(path.join(sessionRoot, "analysis", "splitter-readiness-report.json")),
    tagsInputReadinessReport: await readJson(path.join(sessionRoot, "analysis", "tags-input-readiness-report.json")),
    clipboardReadinessReport: await readJson(path.join(sessionRoot, "analysis", "clipboard-readiness-report.json")),
    qrCodeReadinessReport: await readJson(path.join(sessionRoot, "analysis", "qr-code-readiness-report.json")),
    timerReadinessReport: await readJson(path.join(sessionRoot, "analysis", "timer-readiness-report.json")),
    stepsReadinessReport: await readJson(path.join(sessionRoot, "analysis", "steps-readiness-report.json")),
    carouselReadinessReport: await readJson(path.join(sessionRoot, "analysis", "carousel-readiness-report.json")),
    treeViewReadinessReport: await readJson(path.join(sessionRoot, "analysis", "tree-view-readiness-report.json")),
    collapsibleReadinessReport: await readJson(path.join(sessionRoot, "analysis", "collapsible-readiness-report.json")),
    editableReadinessReport: await readJson(path.join(sessionRoot, "analysis", "editable-readiness-report.json")),
    passwordInputReadinessReport: await readJson(path.join(sessionRoot, "analysis", "password-input-readiness-report.json")),
    signaturePadReadinessReport: await readJson(path.join(sessionRoot, "analysis", "signature-pad-readiness-report.json")),
    angleSliderReadinessReport: await readJson(path.join(sessionRoot, "analysis", "angle-slider-readiness-report.json")),
    cascadeSelectReadinessReport: await readJson(path.join(sessionRoot, "analysis", "cascade-select-readiness-report.json")),
    asyncListReadinessReport: await readJson(path.join(sessionRoot, "analysis", "async-list-readiness-report.json")),
    imageCropperReadinessReport: await readJson(path.join(sessionRoot, "analysis", "image-cropper-readiness-report.json")),
    listboxReadinessReport: await readJson(path.join(sessionRoot, "analysis", "listbox-readiness-report.json")),
    datePickerReadinessReport: await readJson(path.join(sessionRoot, "analysis", "date-picker-readiness-report.json")),
    marqueeReadinessReport: await readJson(path.join(sessionRoot, "analysis", "marquee-readiness-report.json")),
    tocReadinessReport: await readJson(path.join(sessionRoot, "analysis", "toc-readiness-report.json")),
    floatingPanelReadinessReport: await readJson(path.join(sessionRoot, "analysis", "floating-panel-readiness-report.json")),
    drawerReadinessReport: await readJson(path.join(sessionRoot, "analysis", "drawer-readiness-report.json")),
    hoverCardReadinessReport: await readJson(path.join(sessionRoot, "analysis", "hover-card-readiness-report.json")),
    navigationMenuReadinessReport: await readJson(path.join(sessionRoot, "analysis", "navigation-menu-readiness-report.json")),
    presenceReadinessReport: await readJson(path.join(sessionRoot, "analysis", "presence-readiness-report.json")),
    menuReadinessReport: await readJson(path.join(sessionRoot, "analysis", "menu-readiness-report.json")),
    tooltipReadinessReport: await readJson(path.join(sessionRoot, "analysis", "tooltip-readiness-report.json")),
...
async function writeAllArtifacts(session: StudySession, analysis: AnalysisBundle, quiz: ReturnType<typeof generateQuiz>, wrongNotes: WrongNote[], attempts: QuizAttempt[], learnerBrief?: LearnerBriefInput): Promise<void> {
  await Promise.all([
    ...
    writeJson(path.join(session.outputPaths.analysis, "daily-summary-report.json"), analysis.dailySummaryReport),
    ...
    writeJson(path.join(session.outputPaths.analysis, "slider-progress-readiness-report.json"), analysis.sliderProgressReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "select-combobox-readiness-report.json"), analysis.selectComboboxReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "toolbar-toggle-readiness-report.json"), analysis.toolbarToggleReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "scroll-area-readiness-report.json"), analysis.scrollAreaReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "avatar-readiness-report.json"), analysis.avatarReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "pin-input-readiness-report.json"), analysis.pinInputReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "pagination-readiness-report.json"), analysis.paginationReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "number-input-readiness-report.json"), analysis.numberInputReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "rating-group-readiness-report.json"), analysis.ratingGroupReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "color-picker-readiness-report.json"), analysis.colorPickerReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "splitter-readiness-report.json"), analysis.splitterReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "tags-input-readiness-report.json"), analysis.tagsInputReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "clipboard-readiness-report.json"), analysis.clipboardReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "qr-code-readiness-report.json"), analysis.qrCodeReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "timer-readiness-report.json"), analysis.timerReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "steps-readiness-report.json"), analysis.stepsReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "carousel-readiness-report.json"), analysis.carouselReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "tree-view-readiness-report.json"), analysis.treeViewReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "collapsible-readiness-report.json"), analysis.collapsibleReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "editable-readiness-report.json"), analysis.editableReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "password-input-readiness-report.json"), analysis.passwordInputReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "signature-pad-readiness-report.json"), analysis.signaturePadReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "angle-slider-readiness-report.json"), analysis.angleSliderReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "cascade-select-readiness-report.json"), analysis.cascadeSelectReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "async-list-readiness-report.json"), analysis.asyncListReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "image-cropper-readiness-report.json"), analysis.imageCropperReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "listbox-readiness-report.json"), analysis.listboxReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "date-picker-readiness-report.json"), analysis.datePickerReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "marquee-readiness-report.json"), analysis.marqueeReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "toc-readiness-report.json"), analysis.tocReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "floating-panel-readiness-report.json"), analysis.floatingPanelReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "drawer-readiness-report.json"), analysis.drawerReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "hover-card-readiness-report.json"), analysis.hoverCardReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "navigation-menu-readiness-report.json"), analysis.navigationMenuReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "presence-readiness-report.json"), analysis.presenceReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "menu-readiness-report.json"), analysis.menuReadinessReport),
    writeJson(path.join(session.outputPaths.analysis, "tooltip-readiness-report.json"), analysis.tooltipReadinessReport),
